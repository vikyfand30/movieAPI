...
import 'package:testapp/constants/api_constants.dart';
                      ...
                      decoration: BoxDecoration(
                          ...
                          gradient: LinearGradient(
                              ...
                              colors: [
                                ...
                                widget.themeData.hintColor.withOpacity(0.3),
                                widget.themeData.hintColor.withOpacity(0.2),
                                widget.themeData.hintColor.withOpacity(0.1),
                              ],
                              stops: const [
                                0.0,
                                0.25,
                    ...
                    child: SizedBox(
                      ...
                      child: Container(
                        decoration: BoxDecoration(
                            color: widget.themeData.primaryColor,
                            border: Border.all(
                                color: widget.themeData.hintColor, width: 3),
                            image: DecorationImage(
                                fit: BoxFit.cover,
                                image: (cast.profilePath == null
                                        ? const AssetImage('assets/images/na.jpg')
                                        : NetworkImage(
                                            '${TMDB_BASE_IMAGE_URL}w500/${cast.profilePath!}'))
